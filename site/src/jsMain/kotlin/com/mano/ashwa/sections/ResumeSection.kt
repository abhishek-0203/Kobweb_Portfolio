...
fun ResumeSection() {
    Column(Modifier.gap(1.cssRem).padding(2.cssRem)) {
        ...
        // Resume download: place your resume PDF at
        // site/src/jsMain/resources/public/Resume/Abhishek_Verma.pdf
        // It will be served at at runtime as /Resume/Abhishek_Verma.pdf
        // and the `download` attribute will prompt the browser to download the file.
        Row(Modifier.padding(top = 1.cssRem)) {
            Column(Modifier.gap(0.25.cssRem)) {
                ...
                A(href = "/Resume/Abhishek_Verma.pdf", attrs = {
                    ...
                    SpanText("Download Resume", Modifier)
                }
            }
        }
